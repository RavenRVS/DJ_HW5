...
Вам необходимо будет создать базу в postgres в соответсвии с настройками в файле <a href="https://github.com/RavenRVS/DJ_HW5/blob/master/smart_home/settings.py">settings.py</a> и прогнать миграции:
